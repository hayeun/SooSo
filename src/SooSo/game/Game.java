...
public class Game {
	...
	// constructor
	public Game(int date, String homeTeam, String awayTeam, String field, byte homeScore, byte awayScore, byte homeHit,
			byte awayHit, byte homeRun, byte awayRun, byte homeError, byte awayError) {
		setDate(date);
